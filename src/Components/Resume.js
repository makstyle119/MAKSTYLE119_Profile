  ...
  render() {
    ...
    return (
      ...
      <div className="row skill">
         ...
         <div className="nine columns main-col">
            <p>I'm study hee about 2 yaer ago.
              i learn here html, css, jawaScript,
              WordPress, Prestashop, adobe PhotoShop,
              Unity, Construct 2, and much more.
              Name 'MAK STYLE 119', I will make
              some funny video with several peopel
              and some dubmash and whatsApp video
              Status in Short This is my hobbie
            </p>
				<div className="bars">
				   <ul className="skills">
					  {skills}
